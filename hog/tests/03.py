  ...
  'suites': [
    ...
    },
    {
      'cases': [
        {
          'code': r"""
          >>> project1-hog.take_turn(5, 0) # Make sure you call roll_dice!
          Called roll dice!
          9002
          """,
          'hidden': False,
      ...
      ...     return 9002
      ...
      >>> project1-hog.roll_dice, old_roll_dice = roll_dice, project1-hog.roll_dice
      """,
      'teardown': r"""
      >>> project1-hog.roll_dice = old_roll_dice
      """,
      'type': 'doctest'
    }
  ]
